...
# Starts a Hadoop hiveserver2
#
# chkconfig: 345 85 15
# description: Hadoop hiveserver2
#
### BEGIN INIT INFO
# Provides:          hdp-hiveserver2
# Short-Description: Hadoop hiveserver2
# Default-Start:     3 4 5
...
if [ -f /etc/default/hive-hiveserver2 ] ; then
  . /etc/default/hive-hiveserver2
fi

HIVE_COMMAND="hiveserver2"
